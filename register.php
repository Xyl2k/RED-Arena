...
$sha1pass = hash("sha512", $data['pwd']);   // SHA512 well... is that enought?
...
if(empty($err)) {
$sql_insert = "INSERT into `users`(`full_name`,`user_email`,`pwd`,`headline`,`tel`,`avatar`,`website`,`date`,`users_ip`,`approved`,`activation_code`,`country`,`user_name`,`title`,`score`) VALUES ('$user_name','$usr_email','$sha1pass','$data[address]','$data[tel]','images/noavatar.jpg','$data[web]','$date','$user_ip','1','$activ_code','$data[country]','$user_name','New Member','0')";
...
<table width="100%" border="0" cellspacing="0" cellpadding="5" class="main">
  ...
  <tr> 
	...
	?></p>
      <div class="box-content"><div class="box"><h2>Registration / Signup</h2>
      <p>Please register a account, before you can start using RED Arena.<br>
        Registration is quick! Please note that fields marked <span class="required">*</span> 
        are required.</p>
	 <?php	
	 if(!empty($err))  {
	   echo "<br><div class=\"msg\"><b><font color=blue>";
	  foreach ($err as $e) {
	    echo "* $e <br>";
	    }
	  echo "</font></b></div>";	
      ...
      <form action="register.php" method="post" name="regForm" id="regForm" >
        <table width="95%" border="0" cellpadding="3" cellspacing="3" class="forms">
          <tr> 
            ...
            </br><td><input name="full_name" type="text" id="full_name" class="required" minlength="5" >
          </tr>
          <tr> 
          ...
          <tr> 
            <td colspan="2"><p align="center"><input name="doRegister" type="submit" id="doRegister" value="Register"></p></td>
          </tr>
          <tr> 
          </tr>
        </table>
